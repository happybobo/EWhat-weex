...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/e1cd993d5c82ae51980ec70cdb13a4ac', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/e1cd993d5c82ae51980ec70cdb13a4ac',undefined,undefined)
	      ...
	      "children": [
	        {
	          "type": "image",
	          "attr": {
	            "src": function () {return this.btns[0]}
	          },
	          "classList": [
	            "img-btn"
	          ]
	      ...
	      "children": [
	        {
	          "type": "image",
	          "attr": {
	            "src": function () {return this.btns[1]}
	          },
	          "classList": [
	            "img-btn"
	          ]
	      ...
	      "children": [
	        {
	          "type": "image",
	          "attr": {
	            "src": function () {return this.btns[2]}
	          },
	          "classList": [
	            "img-btn"
	          ]
	      ...
	      "children": [
	        {
	          "type": "image",
	          "attr": {
	            "src": function () {return this.btns[3]}
	          },
	          "classList": [
	            "img-btn"
	          ]
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		data: function () {return {
			btns: ['http://d2.freep.cn/3tb_170103104452dmli581068.png', 'http://d2.freep.cn/3tb_170103104452vt7y581068.png', 'http://d2.freep.cn/3tb_170103104453j834581068.png', 'http://d3.freep.cn/3tb_170103104453id1g581068.png']
		}},
		methods: {},
		created: function created() {
			var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/rebars', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/repeat-item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "src": function () {return this.loveIt},
	                "cid": function () {return this.cid}
	              },
	              "events": {
	                "click": "loveClick"
	              },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        loveClick: function loveClick(e) {
	            ...
	            } else self.loveIt = 'http://d2.freep.cn/3tb_170104105903vgqp581068.png';
	        }
	    },
	    created: function created() {
	        var self = this;
	  ...
	  "children": [
	    {
	      "type": "image",
	      "attr": {
	        "src": function () {return this.imgbg}
	      },
	      "style": {
	          ...
	          "children": [
	            {
	              ...
	              "append": "tree",
	              "repeat": {
	                "expression": function () {return this.foodItems},
	                "value": "foodItem"
	              },
	              "children": [
	                {
	                  "type": "repeat-item",
	                  "attr": {
	                    "img": function () {return (this.base) + (this.foodItem.image[0])},
	                    "cid": function () {return this.foodItem.id},
	                    "title": function () {return this.foodItem.name},
	                    "detail": function () {return this.foodItem.benefit}
	                  }
	                }
	              ]
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		methods: {
			getCuteData: function getCuteData() {
				var self = this;
				var msg = {};
				msg.condition = {};
				msg.condition.data = 'cute';
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		methods: {
			getFriendData: function getFriendData() {
				var self = this;
				var msg = {};
				msg.condition = {};
				msg.condition.data = 'high';
				apis.getCuteData(msg, function (retdata) {
					var data = JSON.parse(retdata.data);
					console.log(data);
					self.foodItems = data.foodList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		methods: {
			getHungryData: function getHungryData() {
				var self = this;
				var msg = {};
				msg.condition = {};
				msg.condition.data = 'hungry';
				apis.getCuteData(msg, function (retdata) {
					var data = JSON.parse(retdata.data);
					console.log(data);
					self.foodItems = data.foodList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/recommendcute', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/recommendhungry', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/recommendhigh', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/recommendparty', [], function(__weex_require__, __weex_exports__, __weex_module__) {
